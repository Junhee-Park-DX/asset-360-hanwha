...
// Deep import path matches the installed react-pdf@9.2.1 ESM build layout —
// the version the skill's bundled source (`dist/shared/types.js`) targeted
// doesn't exist in this release; verify this path if react-pdf is upgraded.
