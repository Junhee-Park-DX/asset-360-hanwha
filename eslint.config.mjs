...
export default tseslint.config(
  {
    ignores: [
      ...
      '.cursor',
      '.claude',
      // Vendored library source copied verbatim by the integrate-file-viewer
      // skill (src/cognite-file-viewer/**) — maintained upstream by that
      // skill, not authored to this repo's lint/hooks-purity conventions.
